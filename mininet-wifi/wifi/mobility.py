...
from mininet-original.log import debug, info
from mininet-wifi.wifi.link import wirelessLink, Association
from mininet-wifi.wifi.associationControl import associationControl
...
class mobility(object):
    ...
    def controlled_mobility(cls, init_time=0, final_time=0, stations=[],
        ...
        from mininet-wifi.wifi.node import Station
    ...
    def configLinks(cls, node=None):
        ...
        from mininet-wifi.wifi.node import AP
        if node:
